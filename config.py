...
# ошибка установки штрафа себе
self_penalty = '''Нельзя ставить штрафы самому себе!'''
...
# текст "обед"
dinner_text = ['Сегодняшнее время обеда ', 'Сегодня выходим в ', 'Сегодня пойдём кушать в ']
